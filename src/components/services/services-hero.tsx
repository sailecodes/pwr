export default function ServicesHero({
  ...
  return (
    <section
      className="relative grid min-h-[675px] place-items-center px-10 pb-4"
      style={{
    ...
    >
      ...
      <div className="bg-pwr-primary/90 text-pwr-primary-foreground relative z-10 flex max-w-[550px] flex-col gap-6 rounded-md p-8 md:px-16 md:py-12">
        <header>
