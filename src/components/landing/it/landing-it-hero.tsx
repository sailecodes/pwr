    ...
    <section className="rounded-2xl px-4">
      <div
        ...
        <div className="relative z-2 space-y-1">
          <header className="text-lg leading-6 font-bold text-shadow-lg">
        ...
        <div className="bg-pwr-primary absolute -right-2 -bottom-5 z-2 mb-0 flex gap-6 rounded-2xl px-4 py-2">
