    ...
    <main>
      <section className="relative min-h-[700px]">
        ...
        <div className="relative z-10 mx-auto w-fit max-w-7xl px-6 py-8 lg:px-16 lg:py-12">
          <div className="bg-pwr-primary flex w-full flex-col items-center gap-12 rounded-md px-8 py-8 shadow-[0_0_50px_rgba(0,0,0,0.35)] sm:w-fit sm:flex-row lg:px-16 lg:py-12">
            <ContactUs
              isPrimaryForeground
