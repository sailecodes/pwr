...
export const services = [
  ...
  },
  {
    ...
    services: [
      ...
      "Low Voltage Systems",
      "Industrial Electrical Services",
      "Backup Power and Energy Solutions",
    ],
  },
  {
    category: "Distributed Antenna System (DAS)",
    services: ["DAS System Design and Installation"],
  },
  {
    ...
    services: [
      ...
      "Visual Display Solutions",
      "Lighting Systems",
      "Live Streaming & Broadcast & Control System",
      "AV for Commercial Space",
    ],
  },
  {
    category: "Search Engine Marketing",
    services: ["Google Search Ads (PPC)", "Search Engine Optimization"],
  },
  {
